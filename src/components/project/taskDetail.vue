<template>
    <div class="task-detail" id="task-detail">
                                ...
                                <div class="field-list" :class="{'disabled': task.deleted}">
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            <div class="field-left">
                                                ...
                                                <span class="field-name">任务状态</span>
                                            </div>
                                            <div class="field-right">
                                                <a-dropdown :trigger="['click']"
                                                    :disabled="!!task.deleted || !!task.hasUnDone"
                                            ...
                                            <div class="field-right1">
                                                <span class="field-name">特征分支</span>
                                            </div>
                                            <div class="field-right2">
                                                <a-dropdown :trigger="['click']"
                                                    :disabled="!!task.deleted || !!task.hasUnDone"
                                                    :class="{'disabled': task.hasUnDone}">
                                                    <span>
                                                        <div>
                                                            <img src="../../assets/image/common/gitlogo.png" height="25"
                                                                class="logo" alt="logo">
                                                            创建或选择
                                                        </div>
                                                    </span>
                                                    <a-menu class="field-right-menu" slot="overlay"
                                                            :selectable="false"
                                                            @click="gitStatusChange">
                                                        <a-menu-item :key="status.id" v-for="(status, index) in gitStatusList">
                                                            <div class="menu-item-content">
                                                                <span color="green">{{status.name}}</span>
                                                                <!-- <a-icon type="check" class="check muted"
                                                                        v-show="task.status == status.id"></a-icon> -->
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            <div class="field-left">
                                                <a-icon type="deployment-unit" />
                                                <span class="field-name">预期时长</span>
                                            </div>
                                            <div class="field-right">
                                                <a-InputNumber   style="width: 60px;" defaultValue = 5 />
                                                <span> h</span>
                                            </div>  
                                            <div class="field-right1">
                                                <span class="field-name">实际时长</span>
                                            </div>
                                            <div class="field-right2">
                                                <a-InputNumber  style="width: 60px;"  defaultValue = 5 />
                                                <span> h</span>
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="field-right field-date">
                                                ...
                                                <template>
                                                    <a-dropdown :trigger="['click']" v-model="showBeginTime"
                                                        ...
                                                        <div slot="overlay">
                                                            <a-date-picker v-model="task.begin_time" size="small"
                                                                format="MM月DD日 HH:mm" showTime allowClear
                                                                :showToday="false" :open="showBeginTime"
                                                                @ok="doBeginTime(true)">
                                            ...
                                            <div class="field-right2">
                                                <a-dropdown :trigger="['click']" v-model="showEndTime"
                                                    ...
                                                    <div slot="overlay">
                                                        <a-date-picker v-model="task.end_time" size="small"
                                                            format="MM月DD日 HH:mm" showTime allowClear :showToday="false"
                                                            :open="showEndTime" @ok="doEndTime(true)">
                                                            <template slot="renderExtraFooter">
                                                                <a style="position: absolute;" size="small"
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            <div class="field-left">
                                                <a-icon type="user" />
                                                <span class="field-name">发起者</span>
                                            </div>
                                            <div class="field-right">
                                                <a-dropdown :trigger="['click']" v-model="visibleTaskMemberMenu"
                                                    :disabled="!!task.deleted" placement="bottomCenter">
                                                    <a-tooltip :mouseEnterDelay="0.5" v-if="!task.deleted">
                                                        <template slot="title">
                                                            <span>点击设置发起者</span>
                                                        </template>
                                                    ...
                                                    <div slot="overlay">
                                                        <task-member-menu v-if="visibleTaskMemberMenu"
                                                            :projectCode="projectCodeCurrent" :taskCode="code"
                                                            @close="init(false)" @inviteProjectMember="
                                                            showInviteMember = true,
                                                            visibleTaskMemberMenu = false"></task-member-menu>
                                                    </div>
                                                </a-dropdown>
                                            </div>
                                            <!-- 设置执行者 -->
                                            ...
                                            <div class="field-right2">
                                                <a-dropdown :trigger="['click']" v-model="visibleTaskMemberMenu1"
                                                    :disabled="!!task.deleted" placement="bottomCenter">
                                                    <a-tooltip :mouseEnterDelay="0.5" v-if="!task.deleted">
                                                        <template slot="title">
                                                            <span>点击设置执行者</span>
                                                    ...
                                                    <div slot="overlay">
                                                        <task-member-menu v-if="visibleTaskMemberMenu1"
                                                            :projectCode="projectCodeCurrent" :taskCode="code"
                                                            @close="init(false)" @inviteProjectMember="
                                                            showInviteMember = true,
                                                            visibleTaskMemberMenu = false"></task-member-menu>
                                        ...
                                        <template>
                                            <a-row :gutter="16" type="flex" justify="center">
                                                <a-col :span="12">
                                                    ...
                                                    <span style="color:black;font-weight:bold;font-size:60px" text-align=“center” >
                                                        {{timerDataSring}}
                                                        <Button   type="primary" size={size} @click="timerStart" style="display: inline-block; vertical-align: middle;  height: 60px; width: 60px; margin-left: 50px; font-size: 15px;">Start</Button>                                    
                                                    </span>
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="field-right width-block">
                                                <div class="task-description" :class="{'disabled': task.deleted}"
                                                    v-show="!showTaskDescriptionEdit" @click="showTaskDesc">
                                                    <div class="description-txt" v-show="task.description"
                                                        v-html="task.description"></div>
                                                    <span v-show="!task.description">添加描述</span>
                                                </div>
                                                <div class="m-t-sm" v-if="hasMoreDesc">
                                                    <a v-show="!showMoreDesc" @click="checkShowMoreDesc(true)">显示更多</a>
                                                    <a v-show="showMoreDesc" @click="checkShowMoreDesc(false)">收起描述</a>
                                                </div>
                                                ...
                                                <div v-show="showTaskDescriptionEdit">
                                                    <editor ref="vueWangeditor" id="editor" :menus="editorConfig.menus">
                                                    </editor>
                    ...
                    <div class="content-right">
                        <div class="header">
                            ...
                            <div class="member-list">
                                <a-tooltip :mouseEnterDelay="0.5" v-for="member in taskMemberList" :key="member.code">
                                    <template slot="title">
                                        <span>{{member.name}} <span v-if="member.is_owner"> · 创建者</span></span>
                                    </template>
                                    <a-avatar class="member-item" icon="user" size="small" :src="member.avatar"
                                ...
                                <a-dropdown :trigger="['click']" placement="bottomCenter"
                                    ...
                                    <div slot="overlay">
                                        <project-member-menu v-if="visibleProjectMemberMenu" :taskCode="code"
                                            :projectCode="projectCodeCurrent" @close="init(false)" @inviteProjectMember="
                                            showInviteMember = true,
                                            visibleProjectMemberMenu = false"></project-member-menu>
                                    </div>
                                </a-dropdown>
                            </div>
                        </div>
                        <div class="log-wrap">
                                                        ...
                                                        <a-list-item :key="index"
                                                            ...
                                                            <a-list-item-meta>
                                                                <a-avatar size="small" slot="avatar" shape="square"
                                                                    icon="link" :src="item.sourceDetail.file_url" />
                                                                <div slot="title">
                                                            ...
                                                            <a class="muted" slot="actions">
                                                                <a-dropdown :trigger="['click']"
                                                                    ...
                                                                    <a-menu v-clipboard="item.sourceDetail.file_url"
                                                                        ...
                                                                        class="field-right-menu" slot="overlay">
                                                                        <a-menu-item key="copy">
                                                                            <a-icon type="link" />
                                                                            <span>复制链接</span>
                                                                        </a-menu-item>
                            ...
                            <!-- <div class="header">
                                <a-dropdown :trigger="['click']">
                                    ...
                                    <a-menu v-model="taskLogType" class="field-right-menu" slot="overlay" selectable>
                                        <a-menu-item key="all">
                                            <div class="menu-item-content">
                                                <span>所有动态</span>
                                            </div>
                           ...
                           <!--  <vue-scroll>
                                <div class="log-list muted">
                                    ...
                                    <div :class="{'log-comment': log.is_comment,'list-item': !log.is_comment}"
                                        ...
                                        <template v-if="log.is_comment">
                                            <div class="log-txt text-default"
                        ...
                        <div class="footer" id="footer">
                            <a-popover trigger="click" placement="top" :visible="showMentions" arrowPointAtCenter
                                :getPopupContainer="getPopup">
                                <template slot="content">
                                    <div class="mentions-content" style="width: 200px;">
                                        <div class="mentions-wrapper" v-for="member in taskMemberList" :key="member.id"
                                ...
                                <a-textarea @focus="commenting = true" @blur="commenting = false" ref="commentText"
                                    v-model="comment" :rows="1" placeholder="支持@提及任务成员，Ctrl+Enter发表评论"
        ...
        <invite-project-member v-model="showInviteMember" :project-code="projectCodeCurrent" v-if="showInviteMember">
        </invite-project-member>
        <a-modal class="work-time-modal" v-model="workTimeDo.modalStatus" :title="workTimeDo.modalTitle"
            :bodyStyle="{paddingBottom:'1px'}" @ok="workTimeHandleSubmit" :confirmLoading="workTimeDo.confirmLoading">
            <a-form layout="vertical" @submit.prevent="workTimeHandleSubmit" :form="workTimeDo.form">
                <div>
                ...
                <a-row :gutter="24">
                    <a-col :span="12">
                        <a-form-item label="开始时间">
                            <a-date-picker showTime format="YYYY年MM月DD日 HH:mm" allowClear placeholder="请选择日期"
                                v-decorator="[
                                    'begin_time',
                    ...
                    <a-col :span="12">
                        <a-form-item label="消耗时间">
                            <a-input type="text" placeholder="请输入数字" addonAfter="小时" v-decorator="[
                                'num',
                    ...
                    <a-col :span="24">
                        <a-form-item label="工作内容">
                            <a-textarea :rows="4" type="text" placeholder="在这期间做了什么" v-decorator="[
                                'content',
                            ]">
                            </a-textarea>
                        </a-form-item>
        ...
        <a-modal v-model="plainWorkTime.modalStatus" :title="plainWorkTime.modalTitle"
            :bodyStyle="{paddingBottom:'1px'}" @ok="workTimePlainHandleSubmit"
            :confirmLoading="plainWorkTime.confirmLoading">
            <a-form layout="vertical" @submit.prevent="workTimePlainHandleSubmit" :form="plainWorkTime.form">
                <a-form-item label="">
                    <a-input type="text" placeholder="请输入数字" addonAfter="小时" v-decorator="[
                        'work_time',
...
// import { dateFormat } from '../../assets/js/dateTime';
...
export default {
    ...
    data() {
        return {
            ...
            gitStatusList: COMMON.GIT_STATUS,
            taskLogList: [],
            taskLogTotal: 0,
            taskMemberList: [],
            workTimeList: [],
    ...
    methods: {
        ...
        clearMemberMenu() {
            ...
            this.visibleTaskMemberMenu1 = false;
        ...
        gitStatusChange(item) {
            console.log("gitBranch Change!");
            // this.task.status = item.key;
            // this.editTask({ status: item.key });
        },
        editTask(data) {
        ...
        dateFormat(time) {
            ...
            var offsetSec = parseInt((date - timerStartTime)/1000);
            var hour = parseInt(offsetSec/3600);
            var min = parseInt((offsetSec - 3600*hour)/60);
            var sec = parseInt(offsetSec - 3600*hour - 60*min);
            timerDataSring = hour + ":" + min + ":" + sec;
            return hour + ":" + min + ":" + sec;
        ...
        timerStart: function () {
            ...
            idx.timer = setInterval(() => {
                // idx.timerdata = new Date();
                var date = new Date();
                var offsetSec = parseInt((date - timerStartTime) / 1000);
                var hour = parseInt(offsetSec / 3600);
                var min = parseInt((offsetSec - 3600 * hour) / 60);
                var sec = parseInt(offsetSec - 3600 * hour - 60 * min);
                idx.timerDataSring = hour + ":" + min + ":" + sec;
            }, 1000)
        }
    }
}
