                    ...
                    <a-badge>
                        <a href="#">
                            <img src="../../assets/image/common/logo.png"
                                ...
                                height="75" class="logo" alt="logo">
                            <p  style="font-size:30px;color:black;width: 50px; position:relative;left:-75px;top: 0px; text-align: center;">Watermelon Project</p>
                            <!-- <p  style="font-size:30px;color:black;position:relative;left:-75px;top: 0px; text-align: center;">Welcome to Watermelon Project</p> -->
...
<style lang="less">
    .userLayout {
        ...
        .container {
            width: 100%;
            min-height: 100%;
            background: #F1E5D8 url(~@/assets/image/common/background.svg) no-repeat 50%;
            background-size: 100%;
